        ...
        <ExerciseCard exercise={exercise}>
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="flex items-center justify-center w-7 h-7 rounded-full border border-border bg-background text-muted-foreground opacity-0 group-hover/item:opacity-100 transition-opacity duration-200 cursor-pointer hover:text-destructive"
                >
